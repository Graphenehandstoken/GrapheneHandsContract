...
Initially, the Dev Wallet will be used to make public donations to Graphene centric efforts, but over time we would like to bring this development in house to start releasing our own Graphene based product lines. The application of Graphene is a new and emerging field that takes a large amount of capital in order to make substantial investments. Million mile batteries from Tesla, rapid charge batteries from Samsung and ultra-lightweight tactile enabled prosthetic limbs are all paving the way toward broader adoption of Graphene, and we want to be part of the revolution!
...
- The development team manually manages the liquidity. All liquidity goes to the Graphene Hands wallet which will be controlled by the development team
